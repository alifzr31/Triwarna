                                  ...
                                  child: SizedBox(
                                    ...
                                    child: PhotoView(
                                      imageProvider: Image.network(
                                              '${ApiUrl.baseStorageUrl}${StorageUrl.attachments}/${controller.tracking.value?.receipt?.image}')
                                          .image,
                              ...
                              Get.dialog(
                                ...
                                Center(
                                  child: SizedBox(
                                    ...
                                    child: PhotoView(
                                      imageProvider: Image.network(
                                              '${ApiUrl.baseStorageUrl}${StorageUrl.signatures}/${controller.tracking.value?.receipt?.signature}')
                                          .image,
                                      backgroundDecoration: const BoxDecoration(
                                        color: Colors.white,
                                      ),
