...
class IncreasePoint extends StatelessWidget {
  IncreasePoint({super.key});
  ...
  Widget build(BuildContext context) {
    return Obx(
      () => controller.pointLoading.value
          ...
          : controller.increasePoint.isEmpty
              ? Container(
                  color: Colors.white,
              ...
              : GroupedListView(
                  elements: controller.increasePoint,
                  groupBy: (element) {
                  ...
                  itemBuilder: (context, element) {
                    ...
                    return BaseListTileRichText(
                      ...
                      richTitle: [
                        const TextSpan(text: 'Poin bertambah dari transaksi '),
                        TextSpan(
